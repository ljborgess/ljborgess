...
```ts
const luciano = {
  role: "Systems Analyst & Developer (Intern)",
  company: "B2ML",
  location: "Brasil",
...
<table>
<tr>
<td width="15%"><b>01/2026 – Atual</b></td>
<td width="20%"><b>B2ML</b><br/><sub>Systems Analyst & Developer</sub></td>
<td width="65%">
Re-arquitetura da Timer API em <b>Plataforma B2ML</b>, monólito modular (timer · client · user · reporting) com correção de vulnerabilidades críticas de controle de acesso e isolamento multi-tenant. Sistema de processamento de formulários para iniciativa ligada ao <b>Banco do Brasil</b>. Criação da <b>Taxonomia de Skills</b> corporativa (framework de 9 blocos usado por RH, PMO e comercial). Manutenção do site anjoacolhedor.com.br.
</td>
</tr>
<tr>
<td><b>08/2025 – 09/2025</b></td>
<td><b>Ninja</b><br/><sub>Backend Developer</sub></td>
<td>
2º lugar entre 60 candidatos em programa de capacitação backend. Desenvolvimento do backend de uma aplicação estilo fórum com chat ao vivo (Java, JavaScript, CSS, HTML).
</td>
</tr>
</table>
